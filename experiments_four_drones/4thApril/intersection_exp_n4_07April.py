...
def joystick_drone_four(drone_four, axis_act_thre, axis_deact_thre):
    # if joystick.get_button_r() and joystick.get_button_lt() > axis_act_thre and joystick.get_button_rb() < axis_deact_thre:
    if joystick.get_button_l() and joystick.get_button_lb() < axis_deact_thre and joystick.get_button_rb() > axis_deact_thre:
        drone_four.take_off_flag = True
        drone_four.event_flag = int(1)
        drone_four.take_off_time = time.time()
...
def land_sequence(drone, scf):
    if time.time() - drone.land_time <= 3.0:
        scf.cf.commander.send_setpoint(0.0, 0, 0, 39000)
...
def crazyflie_control(scf, control_which_flag):
    ...
    Filter_z_1 = GeneralFcn.IIR2Filter(4, [4], 'lowpass', design='cheby2', rs=15, fs=sample_rate)
    ...
    Filter_z_2 = GeneralFcn.IIR2Filter(4, [4], 'lowpass', design='cheby2', rs=15, fs=sample_rate)
    ...
    Filter_z_3 = GeneralFcn.IIR2Filter(4, [4], 'lowpass', design='cheby2', rs=15, fs=sample_rate)
    ...
    Filter_z_4 = GeneralFcn.IIR2Filter(4, [4], 'lowpass', design='cheby2', rs=15, fs=sample_rate)
...
if __name__ == '__main__':
    ...
    drone_one.pos_x.des, drone_one.pos_y.des, drone_one.pos_z.des = -0.6,0.6,0.7

    #drone_two.pos_x.des, drone_two.pos_y.des, drone_two.pos_z.des = pole_to_carterian(mission_radius, theta_ini[1])
    drone_two.pos_x.des, drone_two.pos_y.des, drone_two.pos_z.des = -0.6,-0.6,0.7
    drone_three.pos_x.des, drone_three.pos_y.des, drone_three.pos_z.des = 0.6,0.6,0.7
    drone_four.pos_x.des, drone_four.pos_y.des, drone_four.pos_z.des = 0.6,-0.6,0.7
    ...
    uri_drone_two = 'radio://0/40/2M'
    uri_drone_three = 'radio://1/120/2M'
    uri_drone_four = 'radio://1/10/2M'
